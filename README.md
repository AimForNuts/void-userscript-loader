...
**⚡ Aim Loot Helper** — Stats, DPS, EHP, gear comparison, roll quality, and multi-filter scoring. Independent fork of teCsor Loot Helper maintained by AimForNuts, with its own isolated filter and profile state.
